...
\ifx\true\fabcond $if(fromtel)$ \providecommand\fromtel{\faPhone \hspace{1 mm} $fromtel$} $endif$
\ifx\true\fabcond $if(fromfax)$ \providecommand\fromfax{\faFax \hspace{1 mm} $fromfax$} $endif$
% $if(fromfax)$ \providecommand\fromfax{$fromfax$} $endif$
\ifx\true\fabcond $if(fromemail)$ \providecommand\fromemail{\faEnvelopeO \hspace{1 mm} \href{mailto:}{$fromemail$}} $endif$
\ifx\true\fabcond $if(fromweb)$ \providecommand\fromweb{\faGlobe \hspace{1 mm} \href{https://$fromweb$}{$fromweb$}} $endif$
...
\fancyfoot{}
\fancyfoot[R]{%
    \textcolor{UAgreen}{\rule{\textwidth}{1.5pt}} \\
    % \rule[10pt]{17cm}{1.5pt} \\
